...
<head>
    <title>BIRTHDAY PARTY
        ...
        <style>
            body{
                background:url(live.jpg)no-repeat center fixed;
...
<body>
   <div class="navbar">
    ...
    <table>
        ...
        <option value="ENC5235">LIVE CONCERT</option>
        <option value="ENF235">FESTIVE & FEST</option>
        <option value="ENS235">LIVE SHOW</option></SELECT></TD>
