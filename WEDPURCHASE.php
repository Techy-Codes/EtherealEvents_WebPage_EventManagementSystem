...
<body>
    ...
    <table>
        ...
        <option value="SL1432">WEDDING SILVER</option>
        <option value="GL1432">WEDDING GOLD</option>
        <option value="PT1432">WEDDING PLATINUM</option></SELECT></TD>
    ...
    <script>
            function calc(a)
            {
                if(a.elements[4].checked)
                {
                    ...
                    {
                       a.nprice.value=10000+(a.entry.value*20)
                     }
                     else
                    {
                       a.nprice.value=100000
                     }
                }
            }
